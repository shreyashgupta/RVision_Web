...
class FacultySignUp extends React.Component {
    ...
    handleSubmit = async (event) => {
        ...
        const { email,password,fname,lname,passwordc,FID,file,image,department,phNo,date,selected} = this.state;
        ...
        if(email.length==0 ||fname.length==0 ||lname.length==0 || password.length==0 
            || passwordc.length==0 || FID.length==0 || file==null|| department.length==0)
            ...
            alert("passwords do not match");
                ...
                'Content-Type':'application/json'
                    ...
                    fetch("http://localhost:3000/facultySignUp",d)
                    .then(res=>res.json())
                    .then(data=>{
                    if(data=='success')
                        {
    ...
    render() {
        return (
            ...
            <div className="cover ss center tc">
                ...
                <label className="f1 fw6 ph0 mh0 tc">Add Faculty</label>
                    <main className="br4 ma3 shadow-5 center">
                        <div className="l tc center">
                            ...
                            <div className="mt3">
                                <label className="db fw6 lh-copy f6">FID</label>
                                <input
                                    className="pa2 input-reset ba bg-transparent hover-bg-light-gray hover-black b x"
                                    type="text"
                                    name="FID"
                            ...
                            <div className="mv3">
                                <label className="db fw6 lh-copy f6">Department</label>
                                <Select
                        ...
                        <div className="r tc center">
                            ...
                            <div className='mv3'>
                            <label className="db fw6 lh-copy f6" >Courses to be handled</label>
                            <MultiSelect
                                className="x"
